...
<body class="overflow-x-hidden font-Outfit leading-8 dark:bg-darkTheme dark:text-white">
    ...
    <div id="about" class="w-full px-[12%] py-10 pt-[230px] md:pt-0 scroll-mt-20">
        ...
        <div class="flex w-full flex-col lg:flex-row items-center gap-20 my-20">
         ...
         -translate-x-1/2 -translate-y-1/2" alt="">
            ...
            <div class="flex-1">
                <p class="mb-10 max-w-2xl font-Ovo">I am a Frontend Developer specializing in building responsive,
                    modern websites
                    I create clean, professional designs for portfolios, business sites,and e-commerce platforms.
                    Committed to delivering high-quality web solutions,
                    I continuously enhance my skills to stay ahead in web development.</p>
                ...
                <ul class="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-2xl">
                    <li class="border-[0.5px] border-gray-400 rounded-xl p-6 cursor-pointer hover:lightHover hover:-translate-y-1
                     ...
                     dark:hover:bg-darkHover/50  ">
                        ...
                        <p class="text-gray-600 text-sm dark:text-white/80">HtML,CSS,Javascript</p>
                    </li>
    ...
    <div id="services" class="w-full px-[12%] py-10 scroll-mt-20">
        ...
        hover: -translate-y-1 duration-500 dark:bg-darkHover dark:hover:bg-darkHover dark:hover:shadow-white">
                ...
                <p class="text-sm text-gray-600 leading-5 dark:text-white/80">Web Development is the process of building,
        ...
        hover: -translate-y-1 duration-500 dark:bg-darkHover dark:hover:bg-darkHover dark:hover:shadow-white">
                ...
                <p class="text-sm text-gray-600 leading-5 dark:text-white/80">WordPress development is the process of building,
        ...
        hover: -translate-y-1 duration-500 dark:bg-darkHover dark:hover:bg-darkHover dark:hover:shadow-white">
                ...
                <p class="text-sm text-gray-600 leading-5 dark:text-white/80 ">UI/UX design focuses on creating visually appealing,
                    intuitive,
        ...
        hover:-translate-y-1 duration-500  dark:bg-darkHover dark:hover:bg-darkHover dark:hover:shadow-white">
                ...
                <p class="text-sm text-gray-600 leading-5 dark:text-white/80">Graphic design is the art and practice of creating visual
                    content
    ...
    <!-------------- Contact------------ -->
    <div id="Contact" class="w-full px-[12%] py-10 scroll-mt-20 bg-[url('./images/footer-bg-color.png')] 
bg-no-repeat bg-[length:90%-auto] bg-center dark:bg-none">
